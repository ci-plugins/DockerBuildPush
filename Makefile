...
all:clean proot53_build skopeo_build kaniko_build rice_build executor_build open_source
...
kaniko_build:
    ...
    GOARCH=amd64 GOOS=linux CGO_ENABLED=0 go build -v -ldflags '-extldflags "-static" ' -o ${CURRENT_DIR}/bin_file/executor  github.com/GoogleContainerTools/kaniko/cmd/executor
rice_build:
